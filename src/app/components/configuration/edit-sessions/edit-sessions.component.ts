...
export class EditSessionsComponent extends BaseTabEditConfigurationComponent<Session> implements OnInit, AfterContentChecked {
  constructor(
  ...
  createFormGroup(data?: Session) {
    ...
    let formGroup = this.fb.group({
      ...
      startTime: [data ? this.getTimeFromDate(data.startDate) : null, Validators.required],
      endTime: [data ? this.getTimeFromDate(data.endDate) : null, Validators.required],
